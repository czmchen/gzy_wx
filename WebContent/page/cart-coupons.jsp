...
<body>
    ...
    <c:forEach items="${list}" var="list" varStatus="s">
    	<li onclick="window.location.href='prepareOrder.html?cps_id=${list.cps_id}&addr_id=${addr_id}&cps_name=${list.cps_name}&cps_price=${list.cps_price}&cps_time=${list.cps_time}'">

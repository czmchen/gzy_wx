...
<body>
    ...
    <a href="#" onclick="sort('${list.addr_id }')" >
        ...
        <dd><a href="${pageContext.request.contextPath}/page/getAddressById.html?addr_id=${list.addr_id }">></a></dd>
        <div style="clear:both;"></div>
    </dl>
    </c:forEach>
    
    <button class="drdd-btn" onclick="window.location.href='${pageContext.request.contextPath}/page/getAddressById.html'">新增收货地址</button>

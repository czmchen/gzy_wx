			...
			<table
				...
				<thead>
					<tr class="text-c">
						...
						<th width="5%">头像</th>
						<th width="10%">手机号码</th>
						<th width="10%">内部系统ID</th>
						<th width="10%">内部系统名称</th>
						<th width="10%">内部系统备注</th>
						<th width="15%">添加时间</th>
						<th width="10%">自提点</th>
						<th width="10%">会员卡时效</th>
						<th width="10%">操作</th>
					</tr>
				</thead>
				<tbody>
					<c:forEach items="${list}" var="list" varStatus="s">
						<tr class="text-c" valign="middle">
							<td style="display:table-cell; vertical-align:middle"><input type="checkbox" value="1" name=""></td>
							<td style="display:table-cell; vertical-align:middle">${s.count}</td>
							<td style="display:table-cell; vertical-align:middle">${list.realname}</td>
							<td style="display:table-cell; vertical-align:middle"><img alt="" src="${list.head_img}" width="50" height="50"> </td>
							<td style="display:table-cell; vertical-align:middle">${list.mphone}</td>
							<td style="display:table-cell; vertical-align:middle">${list.custid}</td>
							<td style="display:table-cell; vertical-align:middle">${list.custName}</td>
							<td style="display:table-cell; vertical-align:middle">${list.custRemark}</td>
							<td style="display:table-cell; vertical-align:middle">${list.add_time}</td>
							<td style="display:table-cell; vertical-align:middle">${list.area_name}</td>
							<td style="display:table-cell; vertical-align:middle"><input type="text" id="member_time${s.count}" onfocus="WdatePicker()" 

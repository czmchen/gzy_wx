			...
			<table
				...
				<tbody>
					<c:forEach items="${goods}" var="list" varStatus="s">
						<tr class="text-c">
							<td style="text-align:center;vertical-align:middle;"><input type="checkbox" value="1" name=""></td>
							<td style="text-align:center;vertical-align:middle;">${s.count}</td>
							<td style="text-align:center;vertical-align:middle;">${list.goods_name}</td>
							<td style="text-align:center;vertical-align:middle;">${list.goods_code}</td>
							<td style="text-align:center;vertical-align:middle;"><img alt="" src="${list.goods_img}" width="50" height="50"> </td>
							<td style="text-align:center;vertical-align:middle;">${list.nbox}</td>
							<td style="text-align:center;vertical-align:middle;">${list.goods_price}</td>
							<td style="text-align:center;vertical-align:middle;">${list.add_time}</td>

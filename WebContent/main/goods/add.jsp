	...
	<div class="pd-20" style="width: 80%">
			...
			<div class="row cl">
						...
						<div class="formControls col-10">
							<input type="text" id="goods_code" name="goods_code"
								placeholder="请填写内部系统商品代码" value="" class="input-text" style="width: 80%">
						</div>
			</div><br>
			<div class="row cl">
			...
			<div class="row cl">
				...
				<div class="row cl">
						...
						<input id="goods_img" type="hidden" name="goods_img">
			...
			<div class="row cl">
						...
						<div class="formControls col-10">
							<input type="text" id="nbox"  name="nbox"
								placeholder="请填写一件有几罐" value="" class="input-text" style="width: 80%">
						</div>
			</div><br>
				...
				<div class="row cl">
						...
						<div class="formControls col-10">
							<input type="text" id="goods_price"  name="goods_price"
								placeholder="请填写一罐的价格" value="" class="input-text" style="width: 80%">
						</div>
			</div><br>
			<div class="row cl">
						...
						<div class="formControls col-10">
							<textarea id="goods_detail" name="goods_detail" style="width: 80%;height: 260px;"></textarea>
						</div>
			</div><br>	
					<br>
				<div class="col-10 col-offset-2">
				
						<button onClick="addData()" id="butt"

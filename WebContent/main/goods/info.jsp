...
<script>
			...
			KindEditor.ready(function(K) {
				editor = K.create('textarea[name="goods_detail"]', {
					resizeType : 1,
...
<body>
	...
	<div class="pd-20" style="width: 80%">
			...
			<div class="row cl">
						...
						<div class="formControls col-10">
							<input type="text" id="goods_code" name="goods_code"
								placeholder="请填写内部系统商品代码" value="${list.goods_code }" class="input-text" style="width: 80%">
						</div>
			</div><br>
			<div class="row cl">
						...
						<div class="formControls col-10">
						<select id="ctg_id" name="ctg_id" class="input-text" style="width: 80%">
			...
			<div class="row cl">
				...
				<div class="row cl">
						...
						<input id="goods_img" name="goods_img" type="hidden" value="${list.goods_img}">
					...
					<div class="row cl">
						...
						<div class="formControls col-10">
							<input type="text" id="goods_spe" name="goods_spe"
								placeholder="请填写规格" value="${list.goods_spe }" class="input-text" style="width: 80%">
						</div>
			</div><br>
				<div class="row cl">
			
						<label class="form-label col-2">罐/件：</label>
						<div class="formControls col-10">
							<input type="text" id="nbox"  name="nbox"
								placeholder="请填写一件有几罐" value="${list.nbox }" class="input-text" style="width: 80%">
						</div>
			</div><br>
				<div class="row cl">
			
						<label class="form-label col-2">罐/价格：</label>
						<div class="formControls col-10">
							<input type="text" id="goods_price" name="goods_price"
								placeholder="请填写一罐的价格" value="${list.goods_price }" class="input-text" style="width: 80%">
						</div>
			</div><br>
			<div class="row cl">
						...
						<div class="formControls col-10">
							<textarea name="goods_detail" id="goods_detail" style="width: 80%;height: 260px;">${list.goods_detail }</textarea>
						</div>
			</div>
			</c:forEach>
			<br>	

...
<body>
 	<div style="position:absolute; top:42%; left:42%;">
		...
		<div>
			...
			<div style="font-size: 18px; color: white;display:inline">请扫码登陆甘竹花生油客服系统</div>
		</div>
	</div>
...
<script type="text/javascript">
	function initLoginCode(){
		$.ajax({
			...
			success:function(rs){
				$("#qrCodeImg").val(rs);
				$("#qrCodeImg").attr("src","${pageContext.request.contextPath}/customerservice/common/img/qrcode/"+rs+".jpg");
			}
		})
	}
			...
			success:function(rs){
				if(rs==1){
					...
					window.setTimeout(function(){
						window.location.href='${pageContext.request.contextPath}/customerservice/go2index.html?uuid='+$("#qrCodeImg").val();
					},2000);
				}
			}
		})

...
public class MyX509TrustManager implements X509TrustManager {
	public static void main(String[] args) {
		...
		String path = "D:\\data\\voice";
		String urls = "https://file.api.weixin.qq.com/cgi-bin/media/get?access_token=37_lo7aCu4QYCXBwEFDE2q5zt1lHMGl-5rCfW3qdzOhGNpZ6CvpskyBFF_Oe3rwDOUCqMgQn-E8P-SJbKs7g5PHNFd8OsKtqa8heCb1Rq6NKzoY7_FVywSgUYq7xLcqq7VovM_Ju-8kecKDq1k9QGSgAEADTF&media_id=0UqP8FLzl7Gg7LtATT6Q_gr6xIbsqvCVy6NYs1hZODWo-OP66Ky2bW7TRjb07nST";

		try {
			MyX509TrustManager.downLoadFromUrlHttps(urls, "123.arm", path);
		} catch (Exception e) {
...
//						fileName = (fileName != null && fileName.indexOf("?") == -1) ? fileName

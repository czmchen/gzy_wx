...
//  获取关注事件
    public static RequestTextMessage getRequestFocus(final String xml) throws Exception{
...
//    	getReplyTuwenMessage("a", "b", "c", "d", "e", "f");
    	String xml = "<xml><ToUserName><![CDATA[gh_16a43faeed1e]]></ToUserName>"
    			+ "<FromUserName><![CDATA[olSMfty-Izl7sqsQM493M4YjmEsI]]></FromUserName>"
    			+ "<CreateTime>1678875026</CreateTime>"
    			+ "<MsgType><![CDATA[event]]></MsgType>"
    			+ "<Event><![CDATA[unsubscribe]]></Event>"
    			+ "<EventKey><![CDATA[]]></EventKey>"
    			+ "</xml>";
    	RequestTextMessage ts = getRequestFocus(xml);
    	System.out.println(ts.getFromUserName());
    }
}
